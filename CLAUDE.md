# Workspace: feature-pan-4

**Issue:** PAN-4
**Branch:** feature/pan-4
**Path:** /home/eltmon/projects/panopticon/workspaces/feature-pan-4

## URLs (if workspace has Docker)

| Service | URL |
|---------|-----|
| Frontend | https://feature-pan-4.localhost:3000 |
| API | https://api-feature-pan-4.localhost:8080 |
