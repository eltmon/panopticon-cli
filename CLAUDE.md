# Workspace: feature-pan-6

**Issue:** PAN-6
**Branch:** feature/pan-6
**Path:** /home/eltmon/projects/panopticon/workspaces/feature-pan-6

## URLs (if workspace has Docker)

| Service | URL |
|---------|-----|
| Frontend | https://feature-pan-6.localhost:3000 |
| API | https://api-feature-pan-6.localhost:8080 |
